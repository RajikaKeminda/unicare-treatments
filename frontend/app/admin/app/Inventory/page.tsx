...
import { FaWarehouse, FaRobot } from "react-icons/fa"; // Importing the icons
        ...
        <div className="max-w-6xl w-full mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="group cursor-pointer relative rounded-lg shadow-lg overflow-hidden border-2 border-gray-900 dark:border-gray-600 h-96">
              ...
              <div
                onClick={() => handleNavigation("/admin/app/Inventory/Inventory-see")}
            ...
            <div className="group cursor-pointer relative rounded-lg shadow-lg overflow-hidden border-2 border-gray-900 dark:border-gray-600 h-96">
              ...
              <div
                onClick={() => handleNavigation("/admin/app/Inventory/supplier")} // Corrected path
                className="relative group h-64"
              >
                <Image
            ...
            <div className="group cursor-pointer relative rounded-lg shadow-lg overflow-hidden border-2 border-gray-900 dark:border-gray-600 h-96">
              ...
              <div
                onClick={() => handleNavigation("/admin/app/Inventory/ai-help")}
                className="relative group h-64"
              >
                <Image
